	...
	<div class="row">
		...
		<div class="col-10" style="margin-left: 310px;">
			...
			<ul class="nav nav-tabs justify-content-center">
				<li class="nav-item">
					<a class="nav-link ${param.csType eq '' ? 'active':''}" aria-current="page" href="list.nadri?csType=">전체</a>
				</li>
				<li class="nav-item">
					<a class="nav-link ${param.csType eq '사이트이용' ? 'active':''}" href="list.nadri?csType=사이트이용">사이트이용</a>
				</li>
				<li class="nav-item">
					<a class="nav-link ${param.csType eq '프로모션' ? 'active':''}" href="list.nadri?csType=프로모션">프로모션</a>
				</li>
				<li class="nav-item">
					<a class="nav-link ${param.csType eq '예약/취소/환불' ? 'active':''}" href="list.nadri?csType=예약/취소/환불">예약/취소/환불</a>
				</li>
				<li class="nav-item">
					<a class="nav-link ${param.csType eq '쿠폰/포인트' ? 'active':''}" href="list.nadri?csType=쿠폰/포인트">쿠폰/포인트</a>
				</li>
				<li class="nav-item">
					<a class="nav-link ${param.csType eq '기타' ? 'active':''}" href="list.nadri?csType=기타">기타</a>
				</li>
			</ul>
